...
<body>
	...
	<form id="queryForm" name="queryForm" action="<c:url value="/biz/TeamType/list.do"/>" method="post" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
             <div class="buttons">
               <button type="submit" class="regular" name="query" onclick="getReferenceForm(this).action='${ctx}/biz/TeamType/list.do'" >
                 <img src="<c:url value="/image/form/query.gif"/>" alt="" /> 查询
               </button>
               <button type="submit" class="positive" name="additem" onclick="getReferenceForm(this).action='${ctx}/biz/TeamType/create.do'" >
                 <img src="<c:url value="/image/form/add.gif"/>" alt="" /> 新增
               </button> 
               
               <button type="button" class="negative" name="deleteitem" onclick="batchDelete('${ctx}/biz/TeamType/delete.do','items',document.forms.queryForm)">
		  ...
		  <tbody>
		      <c:choose>
			   ...
			   <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td>
					<a href="${ctx}/biz/TeamType/show.do?id=${item.id}&" title="查看" > <img src="<c:url value='/image/form/view.png'/>" alt="查看"  /></a>&nbsp;
					<a href="${ctx}/biz/TeamType/edit.do?id=${item.id}&" title="修改" > <img src="<c:url value='/image/form/edit.gif'/>" alt="修改"  /></a>
				</td>
			  </tr>
		  	  </c:forEach>
		  	  </c:when>
