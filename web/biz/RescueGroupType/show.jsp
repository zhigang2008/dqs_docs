...
<!-- Header -->
	...
	<s:form action="/biz/RescueGroupType/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/biz/RescueGroupType/list.do'" >
		...
		<table id="formtable" class="formtable">
			...
			<tr>	
				...
				<td><s:property value="%{model.groupFunction}" /></td>
			</tr>
		</table>
		</div>
	</s:form>
