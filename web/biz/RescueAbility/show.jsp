...
<!-- Header -->
	...
	<s:form action="/biz/RescueAbility/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/biz/RescueAbility/list.do'" >
		...
		<table id="formtable" class="formtable">
			<tr>	
				...
				<td><s:property value="%{model.abilityName}" /></td>
			</tr>
			<tr>	
				<td class="tdlabel">能力描述: </td>	
				<td><s:property value="%{model.abilityDesc}" /></td>
			</tr>
		</table>
		</div>
	</s:form>
