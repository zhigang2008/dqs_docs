...
<!-- Header -->
	...
	<s:form action="/biz/TeamEquipment/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/biz/TeamEquipment/list.do'" >
		...
		<table id="formtable" class="formtable">
			...
			<tr>	
				...
				<td><s:property value="%{model.equipmentId}" /></td>
			</tr>
		</table>
		</div>
	</s:form>
