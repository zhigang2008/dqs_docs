...
<body>
	...
	<s:form id="myForm" action="/biz/RescueTeam/update.do" method="post">
		...
		<p>可承担的救援职能:</p>
		 <div><s:checkboxlist name="abilityIds" list="%{baseCode.rescueAbility}" listKey="Id" listValue="abilityName"></s:checkboxlist></div>
		</div>
	</s:form>
	</div>
	<!-- footer -->
