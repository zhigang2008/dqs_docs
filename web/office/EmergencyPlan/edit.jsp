...
<body>
	...
	<s:form id="myForm" action="/office/EmergencyPlan/update.do" method="post">
        ...
        <p>基本信息:</p>
         <!-- 隐藏信息 -->
		<s:hidden label="上传文件" id="documentFile" name="planFile" value="%{model.planFile}"  cssClass="required" required="false" />
		...
		<td>
		    ...
		    <div id="fileShowName"><s:property value="%{model.planFile}"/></div>
		 </td>
		</tr>
		</table>
		</div>
