...
<body>
	...
	<form id="queryForm" name="queryForm" action="<c:url value="/office/EmergencyPlan/list4submitter.do"/>" method="post" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
             <div class="buttons">
               <button type="submit" class="regular" name="query" onclick="getReferenceForm(this).action='${ctx}/office/EmergencyPlan/list4submitter.do'" >
                 <img src="<c:url value="/image/form/query.gif"/>" alt="" /> 查询
               </button>
               <wylb:hasPermission name="EmergencyPlan:create"></wylb:hasPermission>
               <button type="submit" class="positive" name="additem" onclick="getReferenceForm(this).action='${ctx}/office/EmergencyPlan/create4submitter.do'" >
                 <img src="<c:url value="/image/form/add.gif"/>" alt="" /> 提交新方案
               </button> 
               
               <wylb:hasPermission name="EmergencyPlan:delete">
               <button type="button" class="negative" name="deleteitem" onclick="batchDelete('${ctx}/office/EmergencyPlan/delete4submitter.do','items',document.forms.queryForm)">
	...
	<div class="cl"></div>
	<div class="gridTable">
        <simpletable:pageToolbar page="${page}">已提交应急方案</simpletable:pageToolbar>
		      ...
		      <c:choose>
			   ...
			   <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td>
					...
					<a href="${ctx}/office/EmergencyPlan/edit4submitter.do?id=${item.id}&" title="修改" > <img src="<c:url value='/image/form/edit.gif'/>" alt="修改"  /></a>
					</c:if>
