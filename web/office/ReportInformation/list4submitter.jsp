...
<body>
	...
	<form id="queryForm" name="queryForm" action="<c:url value="/office/ReportInformation/list4submitter.do"/>" method="post" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
             <div class="buttons">
               <button type="submit" class="regular" name="query" onclick="getReferenceForm(this).action='${ctx}/office/ReportInformation/list4submitter.do'" >
                 <img src="<c:url value="/image/form/query.gif"/>" alt="" /> 查询
               </button>
               <wylb:hasPermission name="ReportInformation:create">
               <button type="submit" class="positive" name="additem" onclick="getReferenceForm(this).action='${ctx}/office/ReportInformation/create4submitter.do'" >
                 <img src="<c:url value="/image/form/add.gif"/>" alt="" /> 新增
               </button> 
               </wylb:hasPermission>
               <wylb:hasPermission name="ReportInformation:delete">
               <button type="button" class="negative" name="deleteitem" onclick="batchDelete('${ctx}/office/ReportInformation/delete4submitter.do','items',document.forms.queryForm)">
		      ...
		      <c:choose>
			   ...
			   <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td>
					...
					<a href="${ctx}/office/ReportInformation/edit4submitter.do?id=${item.id}&" title="修改" > <img src="<c:url value='/image/form/edit.gif'/>" alt="修改"  /></a>
					</wylb:hasPermission>
				</td>
			  </tr>
		  	  </c:forEach>
