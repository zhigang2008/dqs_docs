...
<body>
	...
	<s:form id="myForm" action="/office/ReportInformation/save.do" method="post">
		<div id="controlbuttons" class="buttons">
               ...
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/office/ReportInformation/list4submitter.do'" >
        ...
        <s:hidden id="isPublic" name="isPublic" value="false"></s:hidden>
        <p>请填写以下内容:</p>
