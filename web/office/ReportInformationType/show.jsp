...
<!-- Header -->
	...
	<s:form action="/office/ReportInformationType/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/office/ReportInformationType/list.do'" >
		...
		<table id="formtable" class="formtable">
			<tr>	
				...
				<td><s:property value="%{model.typeCode}" /></td>
			</tr>
			<tr>	
		...
		<p>模板样式:</p>
		<div><s:property value="%{model.typeTemplate}" escape="false"/></div>
		</div>
	</s:form>
	</div>
	</div>
