...
<!-- Header -->
	...
	<s:form action="/office/EmergencyPlanType/list.do" method="post" theme="simple">
		<div id="controlbuttons" class="buttons">
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/office/EmergencyPlanType/list.do'" >
