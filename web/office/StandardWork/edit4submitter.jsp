...
<body>
	...
	<s:form id="myForm" action="StandardWork/update4submitter.do" namespace="/office" method="post">
		<div id="controlbuttons" class="buttons">
               ...
               <button type="button" class="regular" name="backlist" onclick="window.location='${ctx}/office/StandardWork/list4submitter.do'" >
