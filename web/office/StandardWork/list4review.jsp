...
<script type="text/javascript" >
		...
		function review(id,status){
			$.getJSON("<s:url value="/office/StandardWork/review.do"/>?id="+id+"&status="+status, function(data){
...
<body>
	...
	<div class="queryPanel">
		...
		<div class="handleControl">
             <div class="buttons">
               <button type="submit" class="regular" name="query" onclick="getReferenceForm(this).action='${ctx}/office/StandardWork/list4review.do'" >
	...
	<div class="cl"></div>
	<div class="gridTable">
        <simpletable:pageToolbar page="${page}">待审批的标准工作程序</simpletable:pageToolbar>
