...
<body>
	...
	<s:form id="myForm" action="StandardWork/save4submitter.do" namespace="/office" method="post">
		...
		<s:hidden label="上传文件" id="documentFile" name="fileName" value="" cssClass="required" required="false" />
