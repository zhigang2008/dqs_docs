...
<body>
	...
	<form id="queryForm" name="queryForm" action="<c:url value="/office/StandardWork/list4view.do"/>" method="post" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
             <div class="buttons">
               <button type="submit" class="regular" name="query" onclick="getReferenceForm(this).action='${ctx}/office/StandardWork/list4view.do'" >
