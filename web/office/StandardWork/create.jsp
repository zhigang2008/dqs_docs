...
<body>
	...
	<s:form id="myForm" action="/office/StandardWork/save.do" method="post">
		...
		<td>
		   <s:select label="状态" list="%{baseCode.documentStatus}" listKey="id" listValue="name" key="status" value="1" cssClass="required  " required="true" />
		 </td>
		</tr>
		</table>
		</div>
