...
@Service
@Transactional
public class DocumentStatusManager extends BaseManager<DocumentStatus,Long>{
	...
	public void setDocumentStatusDao(DocumentStatusDao dao) {
		this.documentStatusDao = dao;
	}
	/* (non-Javadoc)
	 * @see com.steven.framework.base.BaseManager#getEntityDao()
	 */
	public EntityDao getEntityDao() {
		return this.documentStatusDao;
	}
	/**分页查询
	 * @param query 查询条件
	 * @return 封装的Page对象
	...
	public Page findPage(DocumentStatusQuery query) {
		return documentStatusDao.findPage(query);
	}
