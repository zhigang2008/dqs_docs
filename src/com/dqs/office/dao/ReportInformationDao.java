...
@Repository
public class ReportInformationDao extends BaseIbatis3Dao<ReportInformation,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(ReportInformation entity) {
	...
	public Page findPage(ReportInformationQuery query) {
		return pageQuery("ReportInformation.findPage",query);
	}
