...
@Repository
public class EmergencyPlanTypeDao extends BaseIbatis3Dao<EmergencyPlanType,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(EmergencyPlanType entity) {
	...
	public Page findPage(EmergencyPlanTypeQuery query) {
		return pageQuery("EmergencyPlanType.findPage",query);
	}
