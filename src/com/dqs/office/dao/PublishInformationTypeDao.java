...
@Repository
public class PublishInformationTypeDao extends BaseIbatis3Dao<PublishInformationType,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(PublishInformationType entity) {
	...
	public Page findPage(PublishInformationTypeQuery query) {
		return pageQuery("PublishInformationType.findPage",query);
	}
