...
@Repository
public class DocumentStatusDao extends BaseIbatis3Dao<DocumentStatus,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(DocumentStatus entity) {
	...
	public Page findPage(DocumentStatusQuery query) {
		return pageQuery("DocumentStatus.findPage",query);
	}
