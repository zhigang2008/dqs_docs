...
@Repository
public class ReportInformationStatusDao extends BaseIbatis3Dao<ReportInformationStatus,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(ReportInformationStatus entity) {
	...
	public Page findPage(ReportInformationStatusQuery query) {
		return pageQuery("ReportInformationStatus.findPage",query);
	}
