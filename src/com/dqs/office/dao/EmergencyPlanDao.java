...
@Repository
public class EmergencyPlanDao extends BaseIbatis3Dao<EmergencyPlan,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(EmergencyPlan entity) {
	...
	public Page findPage(EmergencyPlanQuery query) {
		return pageQuery("EmergencyPlan.findPage",query);
	}
	
	public EmergencyPlan getByName(java.lang.String v) {
		return (EmergencyPlan)getSqlSessionTemplate().selectOne("EmergencyPlan.getByName",v);
	}	
