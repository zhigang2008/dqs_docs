...
@Repository
public class StandardWorkTypeDao extends BaseIbatis3Dao<StandardWorkType,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(StandardWorkType entity) {
	...
	public Page findPage(StandardWorkTypeQuery query) {
		return pageQuery("StandardWorkType.findPage",query);
	}
