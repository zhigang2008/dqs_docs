...
@Repository
public class PublishInformationDao extends BaseIbatis3Dao<PublishInformation,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(PublishInformation entity) {
	...
	public Page findPage(PublishInformationQuery query) {
		return pageQuery("PublishInformation.findPage",query);
	}
