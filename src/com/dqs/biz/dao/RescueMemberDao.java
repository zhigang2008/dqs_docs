...
@Repository
public class RescueMemberDao extends BaseIbatis3Dao<RescueMember,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueMember entity) {
	...
	public Page findPage(RescueMemberQuery query) {
		return pageQuery("RescueMember.findPage",query);
	}
