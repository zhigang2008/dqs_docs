...
@Repository
public class RescueMemberDetailinfoDao extends BaseIbatis3Dao<RescueMemberDetailinfo,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueMemberDetailinfo entity) {
	...
	public Page findPage(RescueMemberDetailinfoQuery query) {
		return pageQuery("RescueMemberDetailinfo.findPage",query);
	}
