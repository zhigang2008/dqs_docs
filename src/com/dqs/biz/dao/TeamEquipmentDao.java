...
@Repository
public class TeamEquipmentDao extends BaseIbatis3Dao<TeamEquipment,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(TeamEquipment entity) {
	...
	public Page findPage(TeamEquipmentQuery query) {
		return pageQuery("TeamEquipment.findPage",query);
	}
