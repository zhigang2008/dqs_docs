...
@Repository
public class RescueAbilityDao extends BaseIbatis3Dao<RescueAbility,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueAbility entity) {
	...
	public Page findPage(RescueAbilityQuery query) {
		return pageQuery("RescueAbility.findPage",query);
	}
