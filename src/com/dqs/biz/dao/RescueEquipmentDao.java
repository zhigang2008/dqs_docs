...
@Repository
public class RescueEquipmentDao extends BaseIbatis3Dao<RescueEquipment,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueEquipment entity) {
	...
	public Page findPage(RescueEquipmentQuery query) {
		return pageQuery("RescueEquipment.findPage",query);
	}
