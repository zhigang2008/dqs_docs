...
@Repository
public class TeamAbilityDao extends BaseIbatis3Dao<TeamAbility,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(TeamAbility entity) {
	...
	public Page findPage(TeamAbilityQuery query) {
		return pageQuery("TeamAbility.findPage",query);
	}
