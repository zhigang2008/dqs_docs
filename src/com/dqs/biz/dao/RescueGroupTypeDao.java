...
@Repository
public class RescueGroupTypeDao extends BaseIbatis3Dao<RescueGroupType,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueGroupType entity) {
	...
	public Page findPage(RescueGroupTypeQuery query) {
		return pageQuery("RescueGroupType.findPage",query);
	}
