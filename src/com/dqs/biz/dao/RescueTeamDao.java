...
@Repository
public class RescueTeamDao extends BaseIbatis3Dao<RescueTeam,Long>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(RescueTeam entity) {
	...
	public Page findPage(RescueTeamQuery query) {
		return pageQuery("RescueTeam.findPage",query);
	}
	
	public RescueTeam getByTeamName(java.lang.String v) {
		return (RescueTeam)getSqlSessionTemplate().selectOne("RescueTeam.getByTeamName",v);
	}	
