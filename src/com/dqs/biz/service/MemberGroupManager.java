...
@Service
@Transactional
public class MemberGroupManager extends BaseManager<MemberGroup,Long>{
	...
	public void setMemberGroupDao(MemberGroupDao dao) {
		this.memberGroupDao = dao;
	}
	/* (non-Javadoc)
	...
	public Page findPage(MemberGroupQuery query) {
		return memberGroupDao.findPage(query);
	}
	public void removeByMemberId(Long id) {
		memberGroupDao.removeByMemberId(id);
