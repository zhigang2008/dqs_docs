package com.steven.framework.common.web;

import static com.steven.Constants.POST;
import static com.steven.Constants.UTF8;
...
public class RequestUtils {
	...
	public static String getIpAddr(HttpServletRequest request) {
		...
		if (!StringUtils.isBlank(ip) && !"unknown".equalsIgnoreCase(ip)) {
		    ...
		    //如果都没有,则使用原始的request.getRemoteAddr
