...
import com.steven.core.service.GroupManager;
...
public class GroupAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	public void setGroupId(java.lang.Integer val) {
		this.id = val;
	}
	...
	public String delete() {
		for(int i = 0; i < items.length; i++) {
			...
			java.lang.Integer id = new java.lang.Integer((String)params.get("groupId"));
	...
	public String jsonDelete() {
	    try{
		groupManager.removeById(this.id);
	         getJsonResult().setSuccess(true);
