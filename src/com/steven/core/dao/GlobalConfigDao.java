...
@Repository
public class GlobalConfigDao extends BaseIbatis3Dao<GlobalConfig,java.lang.Integer>{
        /* (non-Javadoc)
	 ...
	 */
	public void saveOrUpdate(GlobalConfig entity) {
	...
	public Page findPage(GlobalConfigQuery query) {
		return pageQuery("GlobalConfig.findPage",query);
	}
	
	public GlobalConfig getByParam(java.lang.String v) {
		return (GlobalConfig)getSqlSessionTemplate().selectOne("GlobalConfig.getByParam",v);
	}	
