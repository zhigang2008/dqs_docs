...
@Repository
public class PasswordApplyInfoDao extends BaseIbatis3Dao<PasswordApplyInfo,java.lang.String>{
        /* (non-Javadoc)
	 * @see com.steven.framework.base.BaseIbatis3Dao#getIbatisMapperNamesapce()
	 */
	@Override
	public String getIbatisMapperNamesapce() {
		return "PasswordApplyInfo";
	}
	/* (non-Javadoc)
	 * @see com.steven.framework.base.EntityDao#saveOrUpdate(java.lang.Object)
	 */
	public void saveOrUpdate(PasswordApplyInfo entity) {
	...
	public Page findPage(PasswordApplyInfoQuery query) {
		return pageQuery("PasswordApplyInfo.findPage",query);
	}
